...
import '../App.css';
import '../assets/stylesheets/navbarlinks.css';
...
class Calendar extends Component {
    ...
    render() {
      return (
        <ButtonToolbar>
           <a onClick={this.handleShow}><i className="fa fa-calendar-o"></i></a>
          <Modal
            {...this.props}
          ...
          >
            ...
            <Modal.Body onMouseEnter={this.mouseEnterHandler} onMouseLeave={this.mouseLeaveHandler}>
                <div className={`${this.state.animatethis}`}>
                    <p className={`${this.state.animateWhat} animate`}>Calendario con fines ilustrativos</p>
                </div>
            </Modal.Body>
            <Modal.Footer>
